...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
  <head>
    ...
    <style type="text/css" media="only screen and (min-width: 596px)">
      .fls-logo {
    ...
    <table class="body">
        ...
        <th class="small-12 large-12 columns first last">
          <table>
            <tr>
              <th>
                <center data-parsed="">
                <a href="https://futureleadersummit.org" align="center" class="text-center">
                  <img src="<?= base_url('assets/img/fls.png'); ?>" class="fls-logo">
                </a>
                </center>
              </th>
              <th class="expander"></th>
      ...
      <th class="small-12 large-12 columns first last">
        <table>
          <tr>
            <th>
              <h6 class="text-center">Selamat Bergabung!</h6>
              <center data-parsed="">
              <img src="<?= base_url('uploads/announcement/'.$gambar); ?>" valign="bottom" align="center" class="imagery text-center">
              </center>
            </th>
            <th class="expander"></th>
          </tr>
...
<th class="small-12 large-12 columns first last">
  <table>
    <tr>
      <th>
        <p class="text-center footercopy">Future Leader Summit. All Rights Reserved.</p>
      </th>
      <th class="expander"></th>
    </tr>
  </table>
